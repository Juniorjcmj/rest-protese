...
import br.com.jcmj.restprotese.repository.Proteticos;
...
public class ProteticoService {
    ...
    @Autowired
    private Proteticos repo;

    public Protetico find(Integer id) {
        Optional<Protetico> obj = repo.findById(id);
        return obj.orElseThrow(() -> new ObjectNotFoundException(
                "Objeto não encontrado!:" + id + ", Tipo : " + Protetico.class.getName()));
    }

    @Transactional
    public Protetico insert(Protetico obj) {
        obj = repo.save(obj);
        return obj;
    }

    public Protetico update(Protetico obj) {
        repo.save(obj);
    ...
    public List<Protetico> findAll() {
        List<Protetico> list = repo.findAll();
        return list;
    }
